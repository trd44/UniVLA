...
class FinetuneConfig:
    # fmt: off
    vla_path: str = "/home/hrilab/Documents/.vlas/vla-benchmarking/UniVLA/univla-7b"            # Path to your local UniVLA path
    lam_path: str = "/home/hrilab/Documents/.vlas/vla-benchmarking/UniVLA/univla-latent-action-model/lam-stage-2.ckpt"
    # Directory Paths
    data_root_dir: Path = Path("/home/hrilab/tensorflow_datasets")      # Path to Open-X dataset directory
    dataset_name: str = "hanoi_full"                   # Name of fine-tuning dataset (e.g., `droid_wipe`)
    ...
    # Tracking Parameters
    wandb_project: str = "hanoi-full"                          # Name of W&B project to log to (use default!)
    wandb_entity: str = "tim-duggan93-tufts-university"                              # Name of entity to log under
...
def finetune(cfg: FinetuneConfig) -> None:
    ...
    print("About to try iterating the raw dataset")
    print(vla_dataset)
    print("Length:", len(vla_dataset))  # If __len__ is implemented

    try:
        sample = next(iter(vla_dataset))
        print("Successfully got first sample from dataset")
